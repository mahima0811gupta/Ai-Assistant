...
#     # Check for music
#     music_keywords = ['play', 'song', 'music', 'youtube']
...
#     apps = ['notepad', 'chrome', 'calculator', 'explorer', 'browser', 'paint']
...
#             # Enhanced news query for better results
...
#             if not city:
#                 return "Please specify which city you want the weather for."
            
#             print(f"🌤️ Getting weather for: {city}")
#             result = safe_tool_execution(get_weather._run, city)
#             # Clean up formatting
...
#     city = query.lower()
#     remove_words = ['weather', 'temperature', 'temp', 'of', 'in', 'at', 'the', 'what', 'is', 'forecast', 'for', 'today', 'now']
